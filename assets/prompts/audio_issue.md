...
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/audio/","feedback":"🤖 Agent feedback: <specific, actionable description>"}'
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo#sharedobjecttype)<[AudioEvents](#audioevents)\>
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo#sharedobjecttype)<[AudioPlaylistEvents](#audioplaylistevents)\>
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo#sharedobjecttype)<[RecordingEvents](#recordingevents)\>
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo#sharedobjecttype)<[AudioStreamEvents](#audiostreamevents)\>
