...
Replace "See all languages" in the image with confirmation button and use the earth image from the assets folder properly.

Add ONLY a clickable button on the home screen route (/) to navigate to the language selection screen route.
